...
*** protobuf
Install packages to provide syntax highlighting for protobuf

#+begin_src emacs-lisp :tangle yes
  (use-package protobuf-mode :ensure t :mode (("\\.proto\\'" . protobuf-mode)))
  (use-package org-protobuf :ensure t)
#+end_src

And enable it

#+begin_src emacs-lisp :tangle yes
  (require 'org-protobuf)
#+end_src
...
*** Custom agenda commands
    ...
    #+begin_src emacs-lisp :tangle yes
      ...
      '(("w" "Waiting Tasks" tags-todo "WAIT")))
    #+end_src

*** Add keybinding for agenda month view
    Enable agenda view for the whole month instead of just the current week

    #+begin_src emacs-lisp :tangle yes
      (global-set-key (kbd "C-c a m") 'org-agenda-month-view)
    #+end_src
...
** Protobuf tangling
Enable protobuf tangling by specifying extension

#+begin_src emacs-lisp :tangle yes
  (add-to-list 'org-babel-tangle-lang-exts '("protobuf" . "proto"))
#+end_src
