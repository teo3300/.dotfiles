...
* Personal conf
  Since I stole this file I'm adding all personal config at the end of
  it to easily find my config
...
* Emacs options
  Setting options such as paths an specific variables

** Undo system
   Properly set undo system to undo-redo
